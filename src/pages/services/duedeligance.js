    ...
    <Container className="mt-3 pb-5">
      ...
      <Row className="bg-white mx-3">        
        <Col className="py-5 pl-sm-5 pr-sm-4">
          <h1 className="my-3">
            {TextContents.due_deligance.due_deligance}
          </h1>
          <p className="text-secondary">
            {TextContents.due_deligance.main_text1}
          </p>
          <br/>
          <p className="text-secondary">
            {TextContents.due_deligance.main_text2}
          </p>
          <Row>
            <Col xs={12} className="ml-0 ml-sm-4 bg-lightgray p-4 my-4">
              <h3>{TextContents.due_deligance.paragprah1_header}</h3>
              <p>{TextContents.due_deligance.paragprah1_text1}</p>
              <p>{TextContents.due_deligance.paragprah1_text2}</p>
            </Col>
            <Col xs={12} className="ml-0 ml-sm-4 bg-lightgray p-4 my-4">
              <h3>{TextContents.due_deligance.paragprah2_header}</h3>
              <p>{TextContents.due_deligance.paragprah2_text1}</p>
            </Col>
            <Col xs={12} className="ml-0 ml-sm-4 bg-lightgray p-4 my-4">
              <h3>{TextContents.due_deligance.paragprah3_header}</h3>
              <p>{TextContents.due_deligance.paragprah3_text1}</p>
            </Col>
          </Row>
        </Col>
